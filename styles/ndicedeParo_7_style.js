...
var style_ndicedeParo_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Indice Par");
    ...
    if (value >= 0.000000 && value <= 0.250000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(193,187,0,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
            ...
            style = [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(117,114,0,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
