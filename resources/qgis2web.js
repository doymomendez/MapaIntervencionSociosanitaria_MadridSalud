...
map.getView().fit([422570.610458, 4450593.874865, 458640.014371, 4510432.865039], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de Intervención Sociosanitaria Madrid Salud</h2>';
        return titleElement;
    })(),
